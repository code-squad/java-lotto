...
public class WinningLottoTest {
    ...
    public void 보너스번호및로또번호중복확인여부() {
        new WinningLotto(new Lotto(3,4,11,5,24,43),new LottoNo(43));
    }

    @Test
    public void 당첨번호와로또번호일치여부확인() {

        WinningLotto winningLotto = new WinningLotto(new Lotto(3,4,11,5,24,43),new LottoNo(9));
    ...
    public void 로또보너스번호일치여부() {
        WinningLotto winningLotto = new WinningLotto(new Lotto(3,4,11,5,24,43),new LottoNo(9));
        Lotto lotto = new Lotto(3,4,11,9,24,43);
