...
public class WinningLottosTest {
    ...
    public void init() {
        ...
        lottos.add(new Lotto(() -> toLottoNos(Arrays.asList(1, 2, 3, 7, 8, 9))));
        lottos.add(new Lotto(() -> toLottoNos(Arrays.asList(1, 2, 3, 4, 7, 8))));
        ...
        winningLottos = new Lottos(lottos).getWinningLottos(
                new WinningNumber(toLottoNos(Arrays.asList(1, 2, 3, 4, 5, 6)), new LottoNo(7))
        );
    }
