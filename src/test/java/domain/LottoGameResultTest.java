...
public class LottoGameResultTest {
    ...
    public void init() {
        ...
        lottoGameResult = new LottoGameResult(
                LottoChecker.getWinnerLottos(lottos, new WinningLotto(Arrays.asList(1, 2, 3, 4, 5, 6), 7)),
                4000
        );
    }
    ...
    public void getProfitPercentageTest() {
        ...
        lottoGameResult = new LottoGameResult(
                LottoChecker.getWinnerLottos(lottos, new WinningLotto(Arrays.asList(11, 12, 13, 14, 15, 16), 7)),
                4000
        );
