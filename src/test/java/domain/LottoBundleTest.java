...
public class LottoBundleTest {
    ...
    public void calculateWinStats(){
        ...
        Set<Integer> set3 = new HashSet<>(Arrays.asList(1,2,3,4,8,9));
        Set<Integer> set4 = new HashSet<>(Arrays.asList(43, 44, 1, 2, 3, 4));
        Lotto lottoA = LottoFactory.generateTheLotto(set1);
        Lotto lottoB = LottoFactory.generateTheLotto(set2);
        Lotto lottoC = LottoFactory.generateTheLotto(set3);
        Lotto lottoD = LottoFactory.generateTheLotto(set4);
        ...
        WinningLotto answer = LottoFactory.generateWinningLotto(set1, 30);
