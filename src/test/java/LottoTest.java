...
public class LottoTest {
    ...
    public void rankingTest() {
        Rank rank = new Rank();
        System.out.println(rank.ranking(5));
        rank.increase(5);
        System.out.println(rank.ranking(5));
        int num = 0;
        System.out.println(rank.ranking(num));
        rank.increase(num);
        System.out.println(rank.ranking(num));
    }
    ...
    public void inputTest() {
        ...
        Lotto lotto = Lotto.winnerLottoCreate(InputView.separatorComa(winnerLotto));
        for (int i = 0; i < 6; i++) {
    ...
    public void makeLotto() {
        int lottoNum = 3;
        ArrayList<Lotto> lottos = new LottoFactory(lottoNum).getLottos();
