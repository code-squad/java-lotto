...
public class WinningLottoTest {
    ...
    public void match() {
        ...
        Lotto matchFive = new Lotto(Arrays.asList(1,2,3,4,5,9));
        assertThat(wLotto.match(matchFive)).isEqualTo(5);

        Lotto matchNone = new Lotto(Arrays.asList(10,11,23,14,15,16));
    ...
    public void isBonus() {
        ...
        Lotto match = new Lotto(Arrays.asList(1,2,3,4,5,7));
        assertThat(wLotto.isBonus(match)).isTrue();

        Lotto notMatch = new Lotto(Arrays.asList(1,2,3,4,5,6));
