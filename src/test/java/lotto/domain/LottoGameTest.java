...
public class LottoGameTest {
	...
	public void 당첨번호123456_테스트() {
		...
		assertThat(lottoGame.calculateProfitRate(new LottoWinNumbers(numbers, 7), 5000)).isEqualTo(500);
	}
	...
	public void getResults테스트() {
		lottoGame.generateLottos(5000);
		int numbers[] = {1, 2, 3, 4, 5, 6};
		assertThat(lottoGame.getResults(new LottoWinNumbers(numbers, 7)).size()).isEqualTo(LottoWinType.values().length);
	}
}
