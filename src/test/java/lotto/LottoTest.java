...
public class LottoTest {
    private WinningLotto winningLotto = WinningLotto.of(Lotto.of(1, 2, 3, 4, 5, 6), LottoNumber.of(10));
    ...
    @Test
    public void 당첨확인_2등() {
        Lotto lotto = Lotto.of(1, 2, 3, 4, 5, 10);
    ...
    @Test
    public void 당첨확인_3등() {
        Lotto lotto = Lotto.of(1, 2, 3, 4, 5, 20);
    ...
    @Test
    public void 당첨확인_4등() {
        Lotto lotto = Lotto.of(1, 2, 3, 4, 20, 30);
    ...
    @Test
    public void 당첨확인_5등() {
        Lotto lotto = Lotto.of(1, 2, 3, 10, 20, 30);
    ...
    public void 로또_숫자중복_유효성() {
        Lotto lotto = Lotto.of(1, 1, 1, 4, 5, 6);
    }
}
