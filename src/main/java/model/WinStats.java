...
public class WinStats {
	...
	public enum Result {
		RANK1(0, 6, 2000000000, false), RANK2(1, 5, 30000000, true), RANK3(2, 5, 1500000, false), RANK4(3, 4, 50000,
				false), RANK5(4, 3, 5000, false);
	...
	public String makeStatsResult(Result r) {
		...
		if (r.isMatchUpWithBonus) {
			result = r.matchUpNum + "개 일치, 보너스 볼 일치" + "(" + r.money + ")" + "-"
					+ this.count.getCountByIndex(Result.RANK2) + "개";
			return result;
		}
