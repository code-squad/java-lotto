...
public class ResultView {
    public static void printResult(Lottos lottos, WinningLotto winningLotto) {
        ...
        System.out.println("-------------------------------");
        System.out.println(String.format("3개 일치 : (5000원) - %d개", results.get(4)));
        System.out.println(String.format("4개 일치 : (50000원) - %d개", results.get(3)));
        System.out.println(String.format("5개 일치 : (150000원) - %d개", results.get(2)));
        System.out.println(String.format("5개 일치, 보너스 볼 일치(30000000원)- %d개", results.get(1)));
        System.out.println(String.format("6개 일치 : (2000000000원) - %d개", results.get(0)));
