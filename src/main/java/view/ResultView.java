...
public class ResultView {
    public static void printResult(Lottos lottos, List<Integer> answer) {
        List<Integer> results = lottos.getResult(answer);
        ...
        System.out.println(String.format("총 수익률은 %d%%입니다.", lottos.calcProfit(answer)));
    }
