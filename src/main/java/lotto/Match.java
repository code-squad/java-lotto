...
public enum Match {
    RANKFIFTH(3, false, 5000, "(5등) 3개 일치 (5000원) : "),
    RANKFOURTH(4, false, 50000, "(4등) 4개 일치 (50000원) : "),
    RANKTHIRD(5, false, 1500000, "(3등) 5개 일치 (1500000원) : "),
    RANKSECOND(5, true, 30000000, "(2등) 5개 일치 + 보너스번호 일치 (30000000원) : "),
    RANKFIRST(6, false, 2000000000, "(1등) 6개 일치 (2000000000원) : ");
