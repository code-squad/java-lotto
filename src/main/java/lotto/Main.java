...
public class Main {
	...
	public static void main (String[] args) {
		...
		int bonusNum = InputView.takeBonusNum();		//보너스 번호를 입력받아서 당첨번호 마지막 자리에 넣어준다.
		ArrayList<Integer> result = lottos.makeResult(winningNum, bonusNum);		//최종 결과를 저장할 리스트.
		
		double profit = lottos.calculateMoney(result, money.getPrice());		//번 돈과 투자한 돈을 가지고 수익률을 계산한다.
