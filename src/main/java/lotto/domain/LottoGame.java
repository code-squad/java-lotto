...
public class LottoGame {
    ...
    public Map<LottoWinType, Long> getResults(LottoWinNumbers winNumbers) {
        TreeMap<LottoWinType, Long> winResults = new TreeMap<>(getWinResults(winNumbers));
        ...
        winResults.remove(LottoWinType.MISS);
        return winResults;
    }
    
    private Map<LottoWinType, Long> getWinResults(LottoWinNumbers winNumbers) {
        return lottos.stream()
                .collect(groupingBy(lotto -> winNumbers.match(lotto), HashMap::new, counting()));
    }
