...
public class LottoSeller {
    ...
    public static List<Lotto> buyLotto(BuyInfo buyInfo, LottoNumberCreationStrategy lottoNumberCreationStrategy) {
        ...
        List<Lotto> lottos = new ArrayList<>(buyInfo.getPurchasableTotalQuantity(LOTTO_PRICE));
     ...
     */
    public static List<Lotto> creatManualLottoByTicket(BuyInfo buyInfo) {
        List<Lotto> lottos = new ArrayList<>(buyInfo.getPurchasableTotalQuantity(LOTTO_PRICE));

        //buyInfo.addManualLottos(lottos);
