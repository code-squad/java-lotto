...
public class LottoMachine {
    ...
    public LottoMachine(int money, int bonusBallNumber) {
        this.money = money;
        this.purchasedLottoTickets = new LottoTickets(this.calculatePurchaseTicketAmount(), new LottoNumber(bonusBallNumber));
    }
