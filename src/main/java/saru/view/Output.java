...
public class Output {
    ...
    private static final int FIVE_PRIZE_BONUS = 30000000;
    ...
    public void printStatus() {
        ...
        System.out.printf("3개 일치 (5000원)- %d개\n4개 일치 (50000원)- %d개\n" +
                ...
                result.getFiveHit(), result.getFiveHitBonus(), result.getSixHit());
    ...
    private int calcSumMoney() {
        ...
        int fiveBonusHitMoney = result.getFiveHitBonus() * FIVE_PRIZE_BONUS;
        int sixHitMoney = result.getSixHit() * SIX_PRIZE;

        return threeHitMoney + fourHitMoney + fiveHitMoney + fiveBonusHitMoney + sixHitMoney;
    }
